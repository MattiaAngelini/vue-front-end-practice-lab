    ...
    <section>
        ...
        <div  class="d-lg-flex intro">
            <div class="description d-flex flex-column justify-content-evenly">
                <div>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore animi illo magni beatae perspiciatis doloremque eum architecto blanditiis. 
        ...
        <div class="booleanProj d-flex flex-column flex-lg-row justify-content-evenly gap-4">
            ...
            <div class="description order-lg-2 m-lg-auto">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, commodi similique in at officia autem tempore ipsa debitis harum exercitationem ex rerum, ad minima nesciunt ullam illo ea. Et, doloremque.</p>
                        ...
                        <div class="slide">                
                            <div class="d-md-flex">                             
                                <div :style="widthResponsive" class="description text-center ">
                                    ...
                                    <p class="p-lg-5">{{store.cardsProjects[0].description}}  Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci exercitationem quae id molestias necessitatibus nostrum assumenda, similique nihil voluptatem quod iure, quis consectetur beatae sequi cumque minus enim, aliquam dolorum? Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iusto atque voluptatem sapiente, architecto deleniti obcaecati neque voluptas voluptates placeat consectetur facilis corrupti, earum nam quia ratione libero sed officiis pariatur!lorem quis recusantus deleniti porro, quo vitae aspernatur excepturi. Repellendus. Lorem Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure vero dolor pariatur praesentium, cupiditate sequi. Aliquid ea minima ratione dolorem laborum repellendus sequi, adipisci voluptates illo recusandae velit perspiciatis deserunt.</p>
                       ...
                       <div class="slide">                
                            <div class="d-md-flex">                             
                                <div :style="widthResponsive" class="description text-center ">
                                    ...
                                    <p class="p-lg-5">{{store.cardsProjects[1].description}}lorem Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium illo consequatur quis, ea beatae necessitatibus. Ipsa laudantium, eos magnam, deleniti excepturi incidunt obcaecati dolores iste aperiam dolore, numquam maxime tempora! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsa obcaecati natus, ipsam minima iusto dolorum. Architecto explicabo ullam quisquam iusto unde aperiam voluptatum odit commodi! Fuga, autem quo. Reiciendis, fugiat? lorem quis recusantus deleniti porro, quo vitae aspernatur excepturi. Repellendus. Lorem Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure vero dolor pariatur praesentium, cupiditate sequi. Aliquid ea minima ratione dolorem laborum repellendus sequi, adipisci voluptates illo recusandae velit perspiciatis deserunt.</p>
