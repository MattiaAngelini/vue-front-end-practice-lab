    ...
    <header>
          ...
          <div :style="Columns" class="links">
            <div class="d-flex gap-3 align-items-center">
              ...
              <a class="d-none d-lg-block"  :href="icon.href" v-for="(icon,index) in icons" :key="index"> <i :class="icon.label"></i></a> 
            </div>         
              <a class="d-none d-lg-block" v-for="(link,index) in links" :key="index" :href="link.href"> {{link.label}}</a>   
